...
try {
    ...
    int i = st.executeUpdate("INSERT INTO oldagehome(name,address,contact,no_of_people,no_of_non_veg,no_of_veg,transport,username,password) VALUES('"+name+"','"+address+"','"+contact+"','"+no_of_people+ "','"+no_of_non_veg+"','" +no_of_veg+ "','" +transport+ "','" +username+"','"+password+"')");
